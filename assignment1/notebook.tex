...
\textbf{cs682/classifiers/softmax.py}.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} First implement the naive softmax loss function with nested loops.}
        \PY{c+c1}{\PYZsh{} Open the file cs682/classifiers/softmax.py and implement the}
        \PY{c+c1}{\PYZsh{} softmax\PYZus{}loss\PYZus{}naive function.}
        
        \PY{k+kn}{from} \PY{n+nn}{cs682}\PY{n+nn}{.}\PY{n+nn}{classifiers}\PY{n+nn}{.}\PY{n+nn}{softmax} \PY{k}{import} \PY{n}{softmax\PYZus{}loss\PYZus{}naive}
...
\textbf{Your answer:} \emph{Fill this in}

there are 10 classes

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} Complete the implementation of softmax\PYZus{}loss\PYZus{}naive and implement a (naive)}
        ...
        \PY{k+kn}{from} \PY{n+nn}{cs682}\PY{n+nn}{.}\PY{n+nn}{gradient\PYZus{}check} \PY{k}{import} \PY{n}{grad\PYZus{}check\PYZus{}sparse}
...
numerical: -0.570739 analytic: -0.765234, relative error: 1.455833e-01
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} Now that we have a naive implementation of the softmax loss function and its gradient,}
        ...
        \PY{k+kn}{from} \PY{n+nn}{cs682}\PY{n+nn}{.}\PY{n+nn}{classifiers}\PY{n+nn}{.}\PY{n+nn}{softmax} \PY{k}{import} \PY{n}{softmax\PYZus{}loss\PYZus{}vectorized}
        \PY{n}{tic} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
...
Gradient difference: 37.922964
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} Use the validation set to tune hyperparameters (regularization strength and}
        ...
        \PY{k+kn}{from} \PY{n+nn}{cs682}\PY{n+nn}{.}\PY{n+nn}{classifiers} \PY{k}{import} \PY{n}{Softmax}
        ...
        \PY{k}{for} \PY{n}{lr} \PY{o+ow}{in} \PY{n}{learning\PYZus{}rates}\PY{p}{:}
            \PY{k}{for} \PY{n}{rs} \PY{o+ow}{in} \PY{n}{regularization\PYZus{}strengths}\PY{p}{:}
                \PY{n}{cur\PYZus{}softmax} \PY{o}{=} \PY{n}{Softmax}\PY{p}{(}\PY{p}{)}
                \PY{n}{cur\PYZus{}softmax}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{learning\PYZus{}rate}\PY{o}{=}\PY{n}{lr}\PY{p}{,} \PY{n}{reg}\PY{o}{=}\PY{n}{rs}\PY{p}{,} \PY{n}{num\PYZus{}iters}\PY{o}{=}\PY{l+m+mi}{300}\PY{p}{)}
                \PY{n}{y\PYZus{}train\PYZus{}pred} \PY{o}{=} \PY{n}{cur\PYZus{}softmax}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
                \PY{n}{training\PYZus{}accuracy} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{y\PYZus{}train} \PY{o}{==} \PY{n}{y\PYZus{}train\PYZus{}pred}\PY{p}{)}
                \PY{n}{y\PYZus{}pred} \PY{o}{=} \PY{n}{cur\PYZus{}softmax}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}val}\PY{p}{)}
                \PY{n}{accuracy} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{y\PYZus{}val} \PY{o}{==} \PY{n}{y\PYZus{}pred}\PY{p}{)}        
                \PY{k}{if} \PY{n}{accuracy} \PY{o}{\PYZgt{}} \PY{n}{best\PYZus{}val}\PY{p}{:}
                    \PY{n}{best\PYZus{}val} \PY{o}{=} \PY{n}{accuracy}
                    \PY{n}{best\PYZus{}softmax} \PY{o}{=} \PY{n}{cur\PYZus{}softmax}
                \PY{n}{results}\PY{p}{[}\PY{p}{(}\PY{n}{lr}\PY{p}{,} \PY{n}{rs}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{n}{training\PYZus{}accuracy}\PY{p}{,} \PY{n}{accuracy}\PY{p}{)}
...
best validation accuracy achieved during cross-validation: 0.350000
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} evaluate on test set}
...
\emph{Your explanation}: if the point's score is not within the margin
range

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Visualize the learned weights for each class}
